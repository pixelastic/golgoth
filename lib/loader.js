...
const module = {
  ...
  import(deps) {
    ...
    // Never load firost here, even if part of the dependencies. As firost
    // depends on golgoth already, having a cycling dependency here made things
    // too complex.
    if (result.firost) {
      delete result.firost;
    }
    return result;
  },
  /**
